        ...
        $.ajax({
            ...
            data.forEach((artist) => {
                $.ajax({
                    ...
                    console.log(artist);
                    $('#distrack_list').append('<div class="artist-card-container col-sm-4"><div class="artist-card"><img class="artist-card-image" src="' + artist.picture_url + '"/><div class="row artist-card-info"><div class="release-cover col-sm-4"><img class="release-cover-image" src="https://lastfm-img2.akamaized.net/i/u/300x300/10ede3abec1bb37ad564a80bed01563d.png" /></div><div class="artist-info col-sm-8"><div class="artist-name">' + artist.name + '</div><div class="artist-release">' + release[0].title + '</div></div></div></div></div>');
                })
            })
        })
